Clerk is alreadyinstalled and connected. Wire it into the Next.Js app: provider, auth pages, redirects, route protection, and user menu.

## Design

Use Clerk's 'dark' theme from '@clerk/ui/themes'as the base.

Override Clerk appearance vraiables using the app's existing CSS variables. Do not hardcode colors.

#### Sign-in and sign-up pages:

- large screes: simple two palnel layout
...
- unauthenticaed users redirect to '/sign-in'
